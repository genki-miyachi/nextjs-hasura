...
describe('UserDetail Test Cases', () => {
  it('Should render user detail pre-fetched by getStaticProps', async () => {
    ...
    expect(screen.getByText('2021-01-13T18:06:46.412969+00:00'))
      .toBeInTheDocument
    ...
    expect(screen.getByText('2021-02-13T18:06:46.412969+00:00'))
      .toBeInTheDocument
  })
})
