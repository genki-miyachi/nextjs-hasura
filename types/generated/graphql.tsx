...
export type GetUerIdsQuery = { __typename?: 'query_root', users: Array<{ __typename?: 'users', id: any }> };
...
export const GetUerIdsDocument = gql`
    query GetUerIds {
  users(order_by: {created_at: desc}) {
    id
  }
...
/**
 * __useGetUerIdsQuery__
 *
 * To run a query within a React component, call `useGetUerIdsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUerIdsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUerIdsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetUerIdsQuery(baseOptions?: Apollo.QueryHookOptions<GetUerIdsQuery, GetUerIdsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUerIdsQuery, GetUerIdsQueryVariables>(GetUerIdsDocument, options);
      }
export function useGetUerIdsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUerIdsQuery, GetUerIdsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUerIdsQuery, GetUerIdsQueryVariables>(GetUerIdsDocument, options);
        }
export function useGetUerIdsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetUerIdsQuery, GetUerIdsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetUerIdsQuery, GetUerIdsQueryVariables>(GetUerIdsDocument, options);
        }
export type GetUerIdsQueryHookResult = ReturnType<typeof useGetUerIdsQuery>;
export type GetUerIdsLazyQueryHookResult = ReturnType<typeof useGetUerIdsLazyQuery>;
export type GetUerIdsSuspenseQueryHookResult = ReturnType<typeof useGetUerIdsSuspenseQuery>;
export type GetUerIdsQueryResult = Apollo.QueryResult<GetUerIdsQuery, GetUerIdsQueryVariables>;
